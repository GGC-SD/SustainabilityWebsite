...
describe('RecyclingComponent', () => {
  ...
  beforeEach(() => {
    ...
    let q1: Pledge = new Pledge('recycling', 'test question1', 'Pledge');
    let q2: Pledge = new Pledge('recycling', 'test question2', 'Pledge');
    let q3: Pledge = new Pledge('recycling', 'test question3', 'Already Pledge');
    let q4: Pledge = new Pledge('recycling', 'test question4', 'Do not Pledge');
